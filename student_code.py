        ...
        for i in lines:
            ...
            for word in words:
                ...
                if word not in self.keys_5:
                    self.featureset[word, 5] = 1 / \
                        (len(self.word_dict) + self.count5)
                if word not in self.keys_1:
                    self.featureset[word, 1] = 1 / \
                        (len(self.word_dict) + self.count1)
